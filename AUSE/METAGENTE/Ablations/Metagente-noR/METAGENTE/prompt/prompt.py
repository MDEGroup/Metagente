...
- **Review the current result**: Review the generated description to identify improvements that could be made:
...
# <EXTRACTED_APP'S_DESCRIPTION>
# $extracted_text
# </EXTRACTED_APP'S_DESCRIPTION>""" ver1

# OPTIMIZED_SUMMARIZER_PROMPT = """"Summarize the following extracted text from an app's description into a short term/phrase introducing the app. Prioritize using any existing name/title, feature description, purpose statement, or overview found at the beginning of the extracted text. If such a description or statement is present, especially if it matches the initial lines of the extracted text, use it directly for the summary:

# <EXTRACTED_APP'S_DESCRIPTION>
# $extracted_text
# </EXTRACTED_APP'S_DESCRIPTION>

# The output should be a concise term/phrase that effectively communicates the app's core purpose and unique features."""  # ver2

OPTIMIZED_SUMMARIZER_PROMPT = """"Summarize the following extracted text from an app's description into a short term/phrase introducing the app. Prioritize using any existing name/title, feature description, or purpose statement found at the beginning of the text. If a clear and concise description exists early in the text, use it verbatim as the primary descriptor. Ensure the generated description captures key concepts and ideas, including any specific focus or unique selling point mentioned early in the text:

<EXTRACTED_APP'S_DESCRIPTION>
$extracted_text
</EXTRACTED_APP'S_DESCRIPTION>

The output should include only a short term/phrase introducing the app."""  # ver3
