...
OPTIMIZED_SUMMARIZER_PROMPT = """"Summarize the following app's description into a short term/phrase introducing the app. Prioritize using any existing name/title, feature description, or purpose statement found at the beginning of the description, and ensure it matches the original wording as closely as possible. Focus on capturing the app's core functionality, intended audience, and any unique features mentioned. If a concise name or title is present at the start, use it as the introduction:
...
""""Summarize the following app's description into a short term/phrase introducing the app. Prioritize using any existing name/title, feature description, or purpose statement from the beginning of the description if it matches the app's purpose or key concept. Ensure to highlight key features or concepts, using exact phrases if present, such as "Employee can Login / Logout based On Current Location" or "check your accounts via your phone". If the description includes the phrase "Use [App Name] to [function]", use this structure. 

<APP'S_DESCRIPTION>
$extracted_text
</APP'S_DESCRIPTION>

The output should include only a concise term/phrase introducing the app."""  # ver 1
...
"""Summarize the following app's description into a short term/phrase introducing the app. Prioritize using any existing name/title, feature description, or purpose statement found at the beginning of the description. If the description includes an official or existing name/title that effectively captures the app's key concept or idea, use it directly. The output should include only a concise term/phrase introducing the app.

<APP'S_DESCRIPTION>
$extracted_text
</APP'S_DESCRIPTION>"""  # ver3
