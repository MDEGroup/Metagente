...
OPTIMIZED_SUMMARIZER_PROMPT = """"Summarize the following extracted text from an app's description into a short term/phrase introducing the app. Prioritize using any existing name/title, feature description, or purpose statement from the beginning of the text. If present, use the exact wording to ensure the summary accurately reflects the app's core concept or primary function. The output should include only a concise term/phrase introducing the app. 
