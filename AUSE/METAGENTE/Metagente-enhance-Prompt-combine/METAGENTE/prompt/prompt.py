...
# Steps:
- **Review all candidate prompts**: Analyze the following prompts, their output and its ROUGE score to identify common parts to be included in the final prompt and also includes specific details or conditional key points from these prompts to be included in the final prompt
<CANDIDATE_PROMPTS>
$summarizer_list
</CANDIDATE_PROMPTS>
